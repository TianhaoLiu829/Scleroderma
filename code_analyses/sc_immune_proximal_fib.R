...
cor.test(df_exp[which(df_exp$PGAA!=0),1],df_exp[which(df_exp$PGAA!=0),2],method = 'pearson')
...
cor.test(df_exp[which(meta_ct_case$Active..Inactive=='A'),1],df_exp[which(meta_ct_case$Active..Inactive=='A'),2])
