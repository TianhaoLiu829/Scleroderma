...
img = io.imread('/ix1/wchen/liutianhao/result/pathology_ST/single_cell_label/lung_neo/lung_neo32.tif')
df=pd.read_csv(f'/ix1/wchen/liutianhao/result/pathology_ST/single_cell_label/lung_all/cell_type_neo.csv',index_col=0)
plot_cells(img,df,sample,palette_19,f'/ix1/wchen/liutianhao/result/',True)
