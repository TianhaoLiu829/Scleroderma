...
cor.test(seu_ssc_sep$pseudotime,seu_ssc_sep$SSC_endo_marker1)->a_ssc_sep_endo
cor.test(seu_ls_sep$pseudotime,seu_ls_sep$SSC_endo_marker1)->a_ls_sep_endo
cor.test(seu_ssc_sep$pseudotime,seu_ssc_sep$SSC_fib_marker1)->a_ssc_sep_fib
cor.test(seu_ls_sep$pseudotime,seu_ls_sep$SSC_fib_marker1)->a_ls_sep_fib
...
cor(seu_ssc_all2$min_dis_to_endo_fib,seu_ssc_all2$pseudotime)
seu_ssc_all3<-seu_ssc_all2[,which(!seu_ssc_all2$seurat_clusters%in%c(2))]
cor.test(seu_ssc_all3$min_dis_to_endo_fib,seu_ssc_all3$pseudotime)

#distance~pseudotime imputed in LS and SSc separately
seu_ls_sep2<-seu_ls_sep[,which(!seu_ls_sep$orig.ident%in%c('I_1','J_1'))]
cor.test(seu_ls_sep2$min_dis_to_endo_fib,seu_ls_sep2$pseudotime)
...
root_cells<-colnames(seu_ssc_post)[which(seu_ssc_post$seurat_clusters%in%c(1))]
cds <- order_cells(cds, root_cells = root_cells)  # your chosen root
cds->cds_post
plot_cells(
  cds_post,
...
cor.test(seu_ssc_sep@meta.data$SSC_endo_marker1,seu_ssc_sep$pseudotime)->a_ssc_sep_endo_pre
cor.test(seu_ssc_post@meta.data$SSC_endo_marker1,seu_ssc_post$pseudotime)->a_ssc_sep_endo_post
cor.test(seu_ssc_sep@meta.data$SSC_fib_marker1,seu_ssc_sep$pseudotime)->a_ssc_sep_fib_pre
cor.test(seu_ssc_post@meta.data$SSC_fib_marker1,seu_ssc_post$pseudotime)->a_ssc_sep_fib_post
...
cor.test(seu_ssc_post@meta.data$min_dis_to_endo_fib,seu_ssc_post$pseudotime)->a_ssc_sep_dis_post
cor.test(seu_ssc_sep@meta.data$min_dis_to_endo_fib,seu_ssc_sep$pseudotime)->a_ssc_sep_dis_pre
...
ggsave('p.png',p,width = 2.7,height = 4,dpi = 300)
